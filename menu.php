  ...
  <body class="text-center">
      ...
      <a href="test.php" class="w-50 mt-4 mb-2 btn btn-md btn-primary" type="submit">Personality Test</a> 
      
      <button class="w-50 mt-2 mb-4 btn btn-md btn-secondary" type="submit">View Result</button>

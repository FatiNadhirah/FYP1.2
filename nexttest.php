...
<?php 
$result = mysqli_query($mysqli, "SELECT * FROM question WHERE id=$id");
...
?>
    ...
    <div class="card">
        ...
        <div class="card-body">
          ...
          <?php
          $previous= mysqli_query($mysqli, "SELECT * FROM question WHERE id<$id order by id DESC");

          if($row = mysqli_fetch_array($previous))
          {
          
            echo '<a href="nexttest.php?id='.$row['id'].'"> <button  class="btn btn-primary" type="button">Prev</button></a>';  
          } 
        ...
        $next = mysqli_query($mysqli, "SELECT * FROM question WHERE id>$id order by id ASC");
            ...
            echo '<a href="nexttest.php?id='.$row['id'].'"><button class = "btn btn-primary" type="button">Next</button></a>';  
                ...
                echo '<a href="result.php"><button class = "btn btn-success" type="button">Finish</button></a>';  
            }
        ?>
